...
- ✅ Compiled and packaged as `vscode-copy-relative-path-new-1.0.0.vsix`
- ✅ Committed to git on the `ai` branch
- ✅ Published to GitHub at https://github.com/Bluscream/vscode-copy-relative-path-new
...
```powershell
cd "P:\Visual Studio Code\vscode-copy-relative-path-new"
...
```powershell
code --install-extension vscode-copy-relative-path-new-1.0.0.vsix
```
...
```powershell
cd "P:\Visual Studio Code\vscode-copy-relative-path-new"
gh release create v1.0.1 vscode-copy-relative-path-new-1.0.0.vsix --title "Copy Relative Path (new) v1.0.0" --notes "Initial release
...
- `vscode-copy-relative-path-new-1.0.0.vsix` - The packaged extension
- All source files committed to git
- GitHub repository created and pushed at https://github.com/Bluscream/vscode-copy-relative-path-new
